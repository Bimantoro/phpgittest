...
<div class="container" style="width:50%; margin-top:2%; margin-bottom:2%; background:#fff;">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-4"><button class="btn btn-success" style="width: 100%" type="button" id="and_btn" onclick="and_input();">AND</button></div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					<label>Bias :</label>
					<input type="double" class="form-control" name="bias" required value="0">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		...
		<hr>
		<div align="center">
				<button type="submit" class="btn btn-success" style="width:100%;">Training Data</button>
		</div>
		<br>
